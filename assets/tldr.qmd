...
While prior research documented the effects of gaining Medicaid coverage on Body Mass Index (BMI) and related health behaviors and led to diverging conclusions, there is a notable gap in understanding the effects of losing Medicaid. Ok now good

In this paper, I provide first evidence on the causal effects of losing public health insurance coverage on body weight and relevant health behaviors.

#### **HOW?**

I exploit variation in health insurance coverage induced by Tennessee's 2005 Medicaid reform, which abruptly terminated coverage for approximately 4% (170,000) of Tennessee's childless adults.
...
The use of SDiD and SCM methods in the Tennessee's setting addresses two potential problems in the analysis of single treated clusters.
